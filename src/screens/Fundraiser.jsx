...
export default function Fundraiser() {
  ...
  const buttons = [
    { label: 'Fundraiser 1' ,src:require('../../assets/images/postaudience/public.png')},
    { label: 'Fundraiser 2' ,src:require('../../assets/images/postaudience/friends.png')},
    { label: 'Fundraiser 3' ,src:require('../../assets/images/postaudience/nofriends.png')},
    { label: 'Fundraiser 4' ,src:require('../../assets/images/postaudience/onlyme.png')},
    { label: 'Fundraiser 5' ,src:require('../../assets/images/postaudience/public.png')},
    { label: 'Fundraiser 6' ,src:require('../../assets/images/postaudience/friends.png')},
    { label: 'Fundraiser 7' ,src:require('../../assets/images/postaudience/nofriends.png')},
    { label: 'Fundraiser 8' ,src:require('../../assets/images/postaudience/onlyme.png')},
...
<Image resizeMode='contain' style={{height:30,width:130,right:120}} source={require('../../assets/images/Event/fundraiser.png')}/>
    </View>
...
<TextInput style={{fontSize:14,fontFamily:FONT.Montserrat_Regular,width:'90%',paddingLeft:20,color:themeStyle.BLACK}} placeholderTextColor={themeStyle.GREY} placeholder='Search An Fundraiser'/>
 </View>
 ...
 <View style={{position:'absolute',width:'100%',bottom:50}}>
       <GlobalButton title={'SELECT FUNDRAISER'}/>
       </View>
    </View>
  )
}
