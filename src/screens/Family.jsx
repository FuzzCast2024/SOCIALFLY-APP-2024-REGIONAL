...
export default function Family() {
  ...
  const buttons = [
    { label: 'FAMILY 1' ,src:require('../../assets/images/postaudience/public.png')},
    { label: 'FAMILY 2' ,src:require('../../assets/images/postaudience/friends.png')},
    { label: 'FAMILY 3' ,src:require('../../assets/images/postaudience/nofriends.png')},
    { label: 'FAMILY 4' ,src:require('../../assets/images/postaudience/onlyme.png')},
    { label: 'FAMILY 5' ,src:require('../../assets/images/postaudience/public.png')},
    { label: 'FAMILY 6' ,src:require('../../assets/images/postaudience/friends.png')},
    { label: 'FAMILY 7' ,src:require('../../assets/images/postaudience/nofriends.png')},
    { label: 'FAMILY 8' ,src:require('../../assets/images/postaudience/onlyme.png')},
...
<Image resizeMode='contain' style={{height:30,width:110,right:130}} source={require('../../assets/images/Event//family.png')}/>
    </View>
...
<TextInput style={{fontSize:14,fontFamily:FONT.Montserrat_Regular,width:'90%',paddingLeft:20,color:themeStyle.BLACK}} placeholderTextColor={themeStyle.GREY} placeholder='Search An Family'/>
 </View>
 ...
 <View style={{position:'absolute',width:'100%',bottom:50}}>
       <GlobalButton title={'SELECT FAMILY'}/>
       </View>
    </View>
  )
}
