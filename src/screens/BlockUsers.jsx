...
const data =[
  {
    devicename :'JACOB LOPEZ',
    devicelocation:'BLOCKED ON 01/12/2024',
    logintime:"10:00 AM CST"
  },
  {
    devicename :'JACOB LOPEZ',
    devicelocation:'BLOCKED ON 01/12/2024',
...
<Image resizeMode='contain' style={{height:15,width:89,left:5}} source={require('../../assets/images/Security/block.png')}/>
...
F YOU UNBLOCK USERS, USERS MAY CONTACT YOU AND GO TO YOUR 
LIVE STREAMS, AND SEE YOU PUBLIC PROFILES, AND ABLE TO SEND YOU
FRIENDS REQUESTS. IF YOU UNBLOCK A USER YOU MAY NOT BLOCK THEM
AGAIN FOR 48 HOURS.
</CustomTextRegular>
